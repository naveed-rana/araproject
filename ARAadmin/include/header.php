...
$name = $_SESSION['name'];
 $sql = "SELECT `img` FROM `admins` WHERE user_name = '$name'";
            ...
            <div class="wrapper">
                ...
                <header class="main-header">
                    ...
                    <a href="home.php" class="logo">
                        ...
                        <span class="logo-mini"><b>A</b>ARA</span>
                        <!-- logo for regular state and mobile devices -->
                        <span class="logo-lg"><b>Admin</b>ARA</span>
                    </a>
...
&nbsp;<span class="label label-danger">1</span>
              ...
              <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class=""><a href="show_post.php"><i class="fa fa-eye" aria-hidden="true"></i> <span>Show Post's</span></a></li>
                            <li class="active"><a href="create_post.php"><i class="fa fa-columns"></i> <span>New Post's</span></a></li>
                            <li><a href="user.php"><i class="fa fa-user"></i> <span>User's</span></a></li>
                            <li><a href="message.php"><i class="fa fa-comments"></i> <span>Message Details</span></a></li>
                        </ul>
                        <!-- /.sidebar-menu -->
                    </section>
                    <!-- /.sidebar -->
