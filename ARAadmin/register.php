 ...
 require_once 'include/connection.php';
  ...
  if (isset($_POST['reg_btn'])) {
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
      ...
      $sql = "INSERT INTO `admin_req`( `user_name`, `user_pass`, `img` ) VALUES ('$username','$userpass','$filename')";
...
<div class="register-box">
  <div class="register-logo" >
    <a href="index.php" style="color: white"><b>Admin</b>ARA</a>
  </div>
  <div>
  <h3 > <?php
  ...
  if (isset($_POST['reg_btn'])) {
    if (!$moved || !$run) {
      ...
      echo "<center><h3 style='color:red;padding:10px;border:5px solid red'>Error occor! server has been down please try again</h3></center>";
    }
  }
