  ...
  if(isset($_POST['login_btn']))
  {
    ...
    if(mysqli_num_rows($run) > 0)
    {
     while ($row = mysqli_fetch_array($run)) {
       ...
       echo "<center><h3 style='color:red;padding:10px;border:5px solid red'><b>User Name and Password Mismatch</b></h3></center>";
    ...
    echo "<center><h3 style='color:red;padding:10px;border:5px solid red'>Sorry! there is no user Exits</h3></center>";
    
  }
  
  }
  ?>
    <a href="../../index2.html" style="color: white"><b>Admin</b>ARA</a>
  </div>
  <!-- /.login-logo -->
